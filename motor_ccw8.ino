  ...
  if (cmd.equals("MOTOR")) {
    ...
    while (_step_current_position != _step_target_position) {
      ...
      if (isTopSensorLow || isBottomSensorLow) {
        ...
        delay(1000);
        //Serial.print("ST,0,MOTOR1,0," + String(_step_current_position * STEP_ANGLE) + "," + String(speedPercent) + ",ED\r\n");
        //Serial.print("ST,0,MOTOR2,0," + String(_step_current_position) + "," + String(speedPercent) + ",ED\r\n");
        Serial.print("ST,0,MOTOR_CW,0," + String(_step_current_position / STEP_ANGLE) + "," + String(speedPercent) + ",ED\r\n");
        return;
      }
    ...
    Serial.print("ST,0,MOTOR_CCW,0," + String(_step_current_position/ STEP_ANGLE) + "," + String(speedPercent) + ",ED\r\n"); //when heading home
